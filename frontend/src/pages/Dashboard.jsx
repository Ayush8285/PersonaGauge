...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-slate-400 to-teal-500 p-8 flex flex-col items-center justify-center text-center">
      {/* Hero Section */}
      <div className="mb-16 max-w-screen-lg mx-auto text-white">
        ...
        <Paragraph className="text-3xl mb-6">
        ...
        <Button
          ...
          onClick={() => navigate("/dashboard/uploadcv")}
        >
          Get Started
        </Button>
      </div>
