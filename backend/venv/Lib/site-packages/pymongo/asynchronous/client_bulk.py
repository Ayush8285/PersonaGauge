...
class _AsyncClientBulk:
    ...
    async def _process_results_cursor(
        ...
        if result.get("cursor"):
            coll = AsyncCollection(
                database=AsyncDatabase(self.client, "admin"), name="$cmd.bulkWrite",
            )
    ...
    async def execute_command_unack(self, conn: AsyncConnection,) -> None:
    ...
    async def execute_no_results(self, conn: AsyncConnection,) -> None:
