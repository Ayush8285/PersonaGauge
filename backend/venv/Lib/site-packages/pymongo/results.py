...
class ClientBulkWriteResult(_BulkWriteResultBase):
    ...
    def insert_results(self) -> Mapping[int, InsertOneResult]:
        ...
        return cast(
            Mapping[int, InsertOneResult], self.bulk_api_result.get("insertResults"),
        )
    ...
    def update_results(self) -> Mapping[int, UpdateResult]:
        ...
        return cast(
            Mapping[int, UpdateResult], self.bulk_api_result.get("updateResults"),
        )
    ...
    def delete_results(self) -> Mapping[int, DeleteResult]:
        ...
        return cast(
            Mapping[int, DeleteResult], self.bulk_api_result.get("deleteResults"),
        )
